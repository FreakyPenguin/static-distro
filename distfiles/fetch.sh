...
if [ "$1" = "stage2" ] ; then
    ...
    ${GET} "http://staticdistro.famkaufmann.info/distfiles/xz-5.2.2.tar.gz" || \
...
#stage 1:
${GET} "http://staticdistro.famkaufmann.info/distfiles/sbase-0.0.20170323.tar.gz"
${GET} "http://staticdistro.famkaufmann.info/distfiles/mksh-R54.tgz" || \
...
${GET} "https://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-2.6.3.tar.gz"
${GET} "https://cdn.kernel.org/pub/linux/kernel/v4.x/linux-4.7.5.tar.xz"
${GET} "https://nginx.org/download/nginx-1.12.2.tar.gz"
${GET} "https://www.opensmtpd.org/archives/libasr-201602131606.tar.gz"
${GET} "http://staticdistro.famkaufmann.info/distfiles/musl-fts-1.2.5.tar.gz"
...
${GET} "http://staticdistro.famkaufmann.info/distfiles/ubase-0.0.20160925.tar.gz"
...
${GET} "http://staticdistro.famkaufmann.info/distfiles/expat-2.2.0.tar.bz2"
${GET} "http://staticdistro.famkaufmann.info/distfiles/libuv-v1.9.1.tar.gz"
...
${GET} "http://staticdistro.famkaufmann.info/distfiles/netbsd-curses-0.2.1.tar.gz"
...
${GET} "https://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-2.5.5.tar.gz"
...
${GET} "https://nginx.org/download/nginx-1.12.1.tar.gz"
